...
// --- Defines ---;
// CommunityCellDelegate Protocol;
protocol CommunityCellDelegate: NSObjectProtocol {
...
// CommunityCell Class;
class CommunityCell: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, TTTAttributedLabelDelegate {
    ...
    weak var delegate: CommunityCellDelegate! = nil
    weak var post: Post! {
        didSet {
            // User;
            ...
            photoView.contentOffset = CGPointZero
